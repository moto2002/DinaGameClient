...
public class ImageEffects {
	...
	public static void DrawQuad(Rect destRect)
	{
		GL.Begin (GL.QUADS);		
		GL.TexCoord2( 0.0f, 0.0f ); GL.Vertex3( destRect.x+0.0f, destRect.y+0.0f, 0.1f );
		GL.TexCoord2( 1.0f, 0.0f ); GL.Vertex3( destRect.x+destRect.width, destRect.y+0.0f, 0.1f );
		GL.TexCoord2( 1.0f, 1.0f ); GL.Vertex3( destRect.x+destRect.width, destRect.y+destRect.height, 0.1f );
		GL.TexCoord2( 0.0f, 1.0f ); GL.Vertex3( destRect.x+0.0f, destRect.y+destRect.height, 0.1f );
		GL.End();
	}
