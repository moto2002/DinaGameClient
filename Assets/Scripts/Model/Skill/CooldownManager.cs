...
namespace Assets.Scripts.Logic.Skill
{
    ...
    public class Cooldown : MonoBehaviour
    {
        ...
        public static Cooldown Create(CooldownType type, int id, float cdTime)
        {
    ...
    public class CooldownManager
    {
        ...
        public void AddCooldown(CooldownType type, int id, float cdTime)
        {
        ...
        public void DeleteCooldown(CooldownType type, int id)
        {
            string key = type.ToString() + id;
            Cooldown cool;
        ...
        public Cooldown GetCooldown(CooldownType type, int id)
        {
            string key = type.ToString() + id;
            Cooldown cool;
            cooldownDict.TryGetValue(key, out cool);
